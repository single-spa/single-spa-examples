    ...
    return (
      <div>
        ...
        <p>
          ...
          converted into a single-spa application. Note that the entire application is lazy loaded (single-spa's doing)
		  and that each of the individual react-router routes is lazy loaded (react-router's doing).
        </p>
        <h2>Courses</h2>{' '}
        <ul>
          {courses.map(course => (
