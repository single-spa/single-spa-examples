System.registerDynamic("github:angular/bower-angular@1.3.0/angular.min", [], false, function(__require, __exports, __module) {
    ...
    (function(S, X, u) {
      ...
      function Ra(b) {
        if (null == b || Sa(b))
          return !1;
        var a = b.length;
        return b.nodeType === ka && a ? !0 : I(b) || B(b) || 0 === a || "number" === typeof a && 0 < a && a - 1 in b;
      }
      function r(b, a, c) {
        var d,
            e;
      ...
      function Kd(b) {
        ...
        $a("ng", ["ngLocale"], ["$provide", function(a) {
          ...
          a.provider("$compile", uc).directive({
            ...
            ngValue: te,
            ngModelOptions: ue
          }).directive({ngInclude: ve}).directive(qb).directive(Ac);
          a.provider({
            $anchorScroll: we,
            $animate: xe,
            $browser: ye,
          ...
          if (a)
            ...
            if (q.cookie !== Ma)
              for (Ma = q.cookie, d = Ma.split("; "), ca = {}, f = 0; f < d.length; f++)
                e = d[f], g = e.indexOf("="), 0 < g && (a = l(e.substring(0, g)), ca[a] === u && (ca[a] = l(e.substring(g + 1))));
            return ca;
          }
        };
      ...
      function uc(b, a) {
        ...
        var d = {},
            ...
            f = /(([\d\w_\-]+)(?:\:([^;]+))?;?)/,
            g = Bd("ngSrc,ngSrcset,src,srcset"),
            k = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/,
            h = /^(on[a-z]+|formaction)$/;
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, s, J, v, x, t, T, C, M) {
          ...
          function Q(a, b, c, d, e, f) {
            function g(a, c, d, e) {
              ...
              p = 0;
              for (n = h.length; p < n; )
                k = s[h[p++]], c = h[p++], f = h[p++], c ? (c.scope ? (l = a.$new(), H.$$addScopeInfo(D(k), l)) : l = a, t = c.transcludeOnThisElement ? aa(a, c.transclude, e, c.elementTranscludeOnThisElement) : !c.templateOnThisElement && e ? e : !e && b ? aa(a, b) : null, c(f, l, k, d, t)) : f && f(a, k.childNodes, u, e);
            }
            for (var h = [],
                k,
                l,
            ...
            switch (b.nodeType) {
              case ka:
                ...
                for (var n,
                  ...
                  if (s = ya.test(t))
                    p = Kb(t.substr(6), "-");
                  var H = t.replace(/(Start|End)$/, ""),
                      P;
                  a: {
                    var O = H;
                    if (d.hasOwnProperty(O)) {
                      P = void 0;
                      for (var O = a.get(O + "Directive"),
                          r = 0,
                          aa = O.length; r < aa; r++)
              ...
              case 8:
                try {
                  if (p = e.exec(b.nodeValue))
                    t = ua(p[1]), fa(c, t, "M", h, k) && (g[t] = U(p[2]));
                } catch (x) {}
            }
            c.sort(y);
            return c;
          ...
          function ca(a, d, e, f, g, h, l, q, t) {
            ...
            function M(a, c, f, g, h) {
              ...
              for (g = q.length - 1; 0 <= g; g--)
                t = q[g], $(t, t.isolateScope ? C : c, O, K, t.require && T(t.directiveName, t.require, O, P), xb);
            }
            t = t || {};
            for (var C = -Number.MAX_VALUE,
                P,
                aa = t.controllerDirectives,
                x,
                Q = t.newIsolateScopeDirective,
                ca = t.templateDirective,
                fa = t.nonTlbTranscludeDirective,
                Na = !1,
                A = !1,
                E = t.hasElementTranscludeDirective,
                Y = e.$$element = D(d),
                L,
                ga,
                y,
              ...
              if (C > L.priority)
                break;
              if (y = L.scope)
                L.templateUrl || (G(y) ? (xa("new/isolated scope", Q || P, L, Y), Q = L) : xa("new/isolated scope", Q, L, Y)), P = P || L;
              ga = L.name;
              ...
              if (L.template)
                if (A = !0, xa("template", ca, L, Y), ca = L, y = F(L.template) ? L.template(Y, e) : L.template, y = Oc(y), L.replace) {
                  h = L;
                  ...
                  Y.html(y);
              if (L.templateUrl)
                A = !0, xa("template", ca, L, Y), ca = L, L.replace && (h = L), M = w(a.splice(R, a.length - R), Y, e, g, Na && Ga, l, q, {
          ...
          function w(a, b, c, d, e, f, g, h) {
            var k = [],
                ...
                v = F(t.templateUrl) ? t.templateUrl(b, c) : t.templateUrl,
                J = t.templateNamespace;
            b.empty();
            ...
            return function(a, b, c, d, e) {
              a = e;
              b.$$destroyed || (k ? (k.push(b), k.push(c), k.push(d), k.push(a)) : (l.transcludeOnThisElement && (a = aa(b, l.transclude, e)), l(p, b, c, d, a)));
            };
          }
          function y(a, b) {
          ...
          H.$$addBindingClass = l ? function(a) {
            P(a, "ng-binding");
          } : A;
      ...
      function Ae() {
        ...
        this.$get = ["$injector", "$window", function(d, e) {
          ...
          return function(g, k, h, l) {
            ...
            if (h)
              return h = function() {}, h.prototype = (B(g) ? g[g.length - 1] : g).prototype, m = new h, p && f(k, p, m, q || g.name), E(function() {
                d.invoke(g, m, k, q);
                return m;
              }, {
                instance: m,
      ...
      function Fe() {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function(a, b, c, d, q, p) {
          ...
          function s(c, g, l) {
            ...
            function s(a, b, d, e) {
              b = Math.max(b, 0);
              (200 <= b && 300 > b ? x.resolve : x.reject)({
                data: a,
                status: b,
                headers: Sc(d),
                config: c,
      ...
      function ac(b, a) {
        ...
        this.$$parseLinkUrl = function(d, e) {
          ...
          var f,
              g;
          (f = va(b, d)) !== u ? (g = f, g = (f = va(a, f)) !== u ? c + (va("/", f) || f) : b + g) : (f = va(c, d)) !== u ? g = c + f : c == d + "/" && (g = c);
          g && this.$$parse(g);
          return !!g;
        };
      }
      ...
      function He() {
        ...
        this.html5Mode = function(b) {
          return Va(b) ? (a.enabled = b, this) : G(b) ? (Va(b.enabled) && (a.enabled = b.enabled), Va(b.requireBase) && (a.requireBase = b.requireBase), Va(b.rewriteLinks) && (a.rewriteLinks = b.rewriteLinks), this) : a;
        };
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function(c, d, e, f) {
          ...
          f.on("click", function(b) {
            if (a.rewriteLinks && !b.ctrlKey && !b.metaKey && 2 != b.which) {
              ...
              p.test(g) || !g || e.attr("target") || b.isDefaultPrevented() || !h.$$parseLinkUrl(g, k) || (b.preventDefault(), h.absUrl() != d.url() && (c.$apply(), S.angular["ff-684208-preventDefault"] = !0));
            }
          });
          ...
          c.$watch(function() {
            var a = d.url(),
                b = d.state(),
                f = h.$$replace,
                l = a !== h.absUrl() || h.$$html5 && e.history && b !== h.$$state;
            if (n || l)
      ...
      function Je() {
        ...
        this.$get = ["$filter", "$sniffer", function(c, d) {
          ...
          return function(d, f) {
            ...
            switch (typeof d) {
              case "string":
                return v = d = d.trim(), g = b[v], g || (":" === d.charAt(0) && ":" === d.charAt(1) && (J = !0, d = d.substring(2)), g = new dc(a), g = (new db(g, c, a)).parse(d), g.constant ? g.$$watchDelegate = m : J ? (g = e(g), g.$$watchDelegate = g.literal ? l : h) : g.inputs && (g.$$watchDelegate = k), b[v] = g), q(g, f);
              case "function":
                return q(d, f);
              default:
                return q(A, f);
                      ...
                      try {
                        if (e = m[n])
                          if ((g = e.get(x)) !== (h = e.last) && !(e.eq ? la(g, h) : "number" === typeof g && "number" === typeof h && isNaN(g) && isNaN(h)))
                            r = !0, c = e, e.last = e.eq ? Ca(g, null) : g, e.fn(g, h === q ? g : h, x), 5 > Q && (K = 4 - Q, O[K] || (O[K] = []), u = F(e.exp) ? "fn: " + (e.exp.name || e.exp.toString()) : e.exp, u += "; newVal: " + ra(g) + "; oldVal: " + ra(h), O[K].push(u));
                          else if (e === c) {
                            r = !1;
                            break a;
                          }
 ...
 while (d = d.$parent);
      ...
      function Pe() {
        this.$get = ["$window", "$document", function(b, a) {
          var c = {},
              d = ba((/android (\d+)/.exec(N((b.navigator || {}).userAgent)) || [])[1]),
      ...
      function md(b, a, c, d, e) {
        var f = this,
            g = [],
            k = f.$$parentForm = b.parent().controller("form") || Cb;
        f.$error = {};
        f.$$success = {};
        f.$pending = u;
      ...
      function fb(b, a, c, d) {
        return function(e, f, g, k, h, l, m) {
          ...
          od(e, f, g, k);
          eb(e, f, g, k, h, l);
          var p = k && k.$options && k.$options.timezone,
              n;
          k.$$parserName = b;
        ...
        on: function a(c, d, e, f) {
          ...
          if (Cc(c)) {
            ...
            for (var g = 0 <= d.indexOf(" ") ? d.split(" ") : [d],
              ...
              }) : "$destroy" !== d && c.addEventListener(d, k, !1), l = f[d]);
              l.push(e);
            }
          }
        },
            ...
            this.$get = ["$$q", "$$asyncCallback", "$rootScope", function(a, d, e) {
              ...
              return {
                ...
                setClass: function(a, c, d, e) {
                  ...
                  m ? e && m.options && (m.options = ta.extend(m.options || {}, e)) : (m = {
                    classes: {},
                    options: e
                  }, l = !0);
                  e = m.classes;
      ...
      db.prototype = {
        ...
        assignment: function() {
          var a = this.ternary(),
              c,
              d;
          return (d = this.expect("=")) ? (a.assign || this.throwError("implies assignment but [" + this.text.substring(0, d.index) + "] can not be assigned to", d), c = this.ternary(), E(function(d, f) {
 ...
 while (this.expect(","));
      ...
      var td = function(a) {
        return ["$timeout", function(c) {
          ...
          Pd = td(),
          be = td(!0),
          zf = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/,
          ...
          yd = {
            ...
            checkbox: function(a, c, d, e, f, g, k, h) {
              var l = pd(h, a, "ngTrueValue", d.ngTrueValue, !0),
                  m = pd(h, a, "ngFalseValue", d.ngFalseValue, !1);
              c.on("click", function(a) {
          ...
          Db = "ng-dirty",
          sd = "ng-pending",
          Of = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(a, c, d, e, f, g, k, h, l, m) {
            ...
            var v = e.inheritedData("$formController") || Cb,
                x = 0;
            nd({
              ctrl: this,
              $element: e,
            ...
            this.$commitViewValue = function() {
              ...
              if (n.$$lastCommittedViewValue !== a || "" === a && n.$$hasNativeValidators)
                n.$$lastCommittedViewValue = a, n.$pristine && (n.$dirty = !0, n.$pristine = !1, g.removeClass(e, Qa), g.addClass(e, Db), v.$setDirty()), this.$$parseAndValidate();
            };
            this.$$parseAndValidate = function() {
              var a = n.$$lastCommittedViewValue,
                  c = a,
                  d = w(c) ? u : !0;
              if (d)
        ...
        return {
          ...
          he = ["$locale", "$interpolate", function(a, c) {
            ...
            return {
              ...
              link: function(e, f, g) {
                var k = g.count,
                    h = g.$attr.when && f.attr(g.$attr.when),
                    l = g.offset || 0,
                    m = e.$eval(h) || {},
                    q = {},
                    p = c.startSymbol(),
          ...
          ie = ["$parse", "$animate", function(a, c) {
            ...
            return {
              ...
              compile: function(f, g) {
                var k = g.ngRepeat,
                    h = X.createComment(" end ngRepeat: " + k + " "),
                ...
                return function(a, f, g, l, n) {
                  ...
                  a.$watchCollection(q, function(g) {
                    ...
                    if (Ra(g))
                      ...
                      w = [];
                      for (F in g)
                        g.hasOwnProperty(F) && "$" != F.charAt(0) && w.push(F);
                      w.sort();
                    }
                    C = w.length;
                    F = Array(C);
 ...
 while (H && H.$$NG_REMOVED);
              ...
              link: function(e, g, k, h) {
                  ...
                  function q() {
                    ...
                    for (A = c.length; I < A; I++) {
                      ...
                      R.length <= I ? (s = {
                        ...
                        label: l.label
                      }, u = [s], R.push(u), f.append(s.element)) : (u = R[I], s = u[0], s.label != d && s.element.attr("label", s.label = d));
                      w = null;
                      G = 0;
                      for (D = l.length; G < D; G++)
                        d = l[G], (v = u[G + 1]) ? (w = v.element, v.label !== d.label && (m(N, v.label, !1), m(N, d.label, !0), w.text(v.label = d.label)), v.id !== d.id && w.val(v.id = d.id), w[0].selected !== d.selected && (w.prop("selected", v.selected = d.selected), Pa && w.prop("selected", v.selected))) : ("" === d.id && y ? S = y : (S = t.clone()).val(d.id).prop("selected", d.selected).attr("selected", d.selected).text(d.label), u.push(v = {
                          element: S,
                          label: d.label,
                          id: d.id,
                          selected: d.selected
                ...
                if (h[1]) {
                  ...
                  var n = k.multiple,
                      ...
                      v,
                      x = !1,
                      t = D(X.createElement("option")),
                      E = D(X.createElement("optgroup")),
                      C = t.clone();
                  k = 0;
      ...
      S.angular.bootstrap ? console.log("WARNING: Tried to load angular more than once.") : (Id(), Kd(ta), D(X).ready(function() {
        Ed(X, rc);
      }));
    })(window, document);
...
System.register("entry.js", ["github:angular/bower-angular@1.3.0", "github:angular-ui/ui-router@0.2.8"], function (_export) {
    "use strict";

    var angular;
    return {
        setters: [function (_githubAngularBowerAngular130) {
            angular = _githubAngularBowerAngular130["default"];
        }, function (_githubAngularUiUiRouter028) {}],
        execute: function () {

            angular.module('root-angular-module', ['ui.router']).config(function ($stateProvider, $locationProvider) {
